...
SELECT VendorName, VendorID, VendorAddress1+' '+VendorAddress2 AS "Mailing Address" FROM Vendors;
...
SELECT TOP 10 PERCENT * FROM Invoices ORDER BY InvoiceDate;
--13.	Select the bottom ten percent of invoice line items by amount.
SELECT TOP 10 PERCENT InvoiceLineItemAmount FROM InvoiceLineItems ORDER BY InvoiceLineItemAmount DESC;
...
SELECT * FROM Invoices WHERE InvoiceTotal >= 500 AND InvoiceDate < '01/15/2016';
