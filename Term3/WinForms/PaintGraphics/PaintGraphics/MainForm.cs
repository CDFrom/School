...
namespace PaintGraphics
{
    public partial class MainForm : Form
    {
        ...
        private void MainForm_Paint(object sender, PaintEventArgs e)
        {
            ...
            graphics_context.DrawEllipse(outline, 300, 10, 50, 80);
            ...
            graphics_context.DrawString("Hello there!", font, fill_color, location, draw_format);
            ...
            //picture_Box.Image = Image.FromFile(@"");
