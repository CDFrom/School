...
//
// CalcAreaOfCircle
// Complete this function so that it computes and returns the
...
//
// CalcFactorial
// Complete this function so that it returns the factorial of
// Value.
// Hint: look up what a factorial is if you don't remember.
// Hint: look up what an "edge case" means.
// Hint: look at the preceding function for how to return a
// value.
...
// return zero.
if (Value <= 0) return 0;
// Ok, we know Value is at least one so we can start multiplying 
// factors. Create an unsigned int variable called Answer and
// set its initial value to 1.
unsigned int Answer = 1;
// Keep going as long as Value is greater than zero and keep
// multiplying factors. Use a
...
// Complete this function so it calculates the slope and
// intercept of a line based on two points.
// Notice that it uses pass-by-reference variables for Slope and
// Intercept.
// Hint: review "pass by reference" to ensure you understand how
// it works.
// Hint: look up what it means to return "void" from a function.
// Hint: look up how to calculate the absolute value of a number
// in Arduino C.
//
void CalcSlopeAndIntercept(float X1, float Y1, float X2, float Y2, float &Slope, float &Intercept) {
// Set the Slope and Intercept return parameters to zero before
// we do anything else.
Slope = 0;
Intercept = 0;
// Test for edge case where X2-X1 is zero (slope is undefined,
// line is vertical). If we detect
// this edge case, just return immediately. Remember we are not
// supposed to compare floating point values (conversion
// errors). Instead, calculate the absolute value of the
//difference
